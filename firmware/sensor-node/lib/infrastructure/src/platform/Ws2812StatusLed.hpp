...
// On-board WS2812 RGB LED (SuperMini: GPIO8) driven via Arduino-ESP32
...
// inside rgbLedWrite() (RGB_BUILTIN_LED_COLOR_ORDER). Copy of the coordinator
// adapter — both boards use the identical Arduino API.
